export const pl = {
  ...
  downloadSaved: 'Zapisano {file}.',
  downloadFailed: 'Nie udało się pobrać {file}.',
  downloadCancelled: 'Pobieranie {file} anulowane.',
  downloadGone: 'Pliku {file} nie ma już tam, gdzie został zapisany.',
